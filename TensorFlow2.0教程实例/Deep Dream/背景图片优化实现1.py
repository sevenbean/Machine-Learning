...
inital_shape=tf.shape(img)[:-1]
#从小到大比例进行多次优化过程
for octave in range(-2,3):
    new_size=tf.cast(tf.convert_to_tensor(inital_shape),tf.float32)*(OCT_SCALE**octave)
...
filename="deepdream_{}背景图片优化1.jpg".format(layer_names)
